...
import com.travelagent.travelagent.application.agent.port.in.AgentConversationUseCase;
...
@Service
@Slf4j
public class DefaultReactAgentService implements AgentConversationUseCase {
