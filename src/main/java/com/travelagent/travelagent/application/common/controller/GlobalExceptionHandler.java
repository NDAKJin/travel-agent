package com.travelagent.travelagent.application.common.controller;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidationException(MethodArgumentNotValidException ex) {
        ...
        Map<String, Object> body = error("VALIDATION_ERROR",
                fields.values().stream().findFirst().orElse("Request validation failed"));
