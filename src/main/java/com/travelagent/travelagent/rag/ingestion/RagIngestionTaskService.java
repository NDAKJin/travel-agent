...
public class RagIngestionTaskService {
    ...
    public List<RagIngestionTaskResponse> submit(List<MultipartFile> files) {
        ...
        for (MultipartFile file : files) {
            ...
            try {
                ...
                String payload = JSON.toJSONString(new Message(id, path.toString(), file.getContentType(), name));
    ...
    public record Message(long taskId, String path, String contentType, String fileName) { }
}
